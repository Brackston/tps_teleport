##*uc_teleport* is a mod for Minetest game server.

##Description:
This is a modification of the *tps_teleport* mod to allow or disallow the teleport request system via priv (*tp_allow*).
...
##Privileges:
- **interact** and **tp_allow** Permits use of /tpr and /tphr.
- **tp_tpc** and **tp_allow** Permits use of /tpc
- **tp_admin** Admin priv allows admin to teleport anywhere without permission
- **tp_allow** Additional check to allow interacted players permission to use teleport; added by Brackston 8-19-2017
